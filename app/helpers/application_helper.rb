module ApplicationHelper
  ...
  def meta_image(filename)
    filename = "meta.png" unless filename.present?
    meta_tag = tag("meta", property: "og:image", content: image_url(filename))
    meta_tag += tag("meta", property: "twitter:image", content: image_url(filename))
    meta_tag.html_safe
  end
end
